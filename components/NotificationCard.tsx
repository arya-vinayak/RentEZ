  ...
  return (
    <>
      {notifications.map((notification) => (
        <div className="w-90% m-3 p-2 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-black dark:border-gray-700 dark:hover-bg-gray-700">
          ...
          <p className="text-xs text-gray-500 dark:text-gray-300 text-right mt-2">
            {notification.date_of_announcement.toLocaleDateString()}
          </p>
        </div>
      ))}
    </>
